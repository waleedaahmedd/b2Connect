...
import 'package:b2connect_flutter/view/screens/products_filter_screen.dart';
...
class ViewAllOffersScreen extends StatefulWidget {
  const ViewAllOffersScreen(int this.perPage,
      {this.categoryId,
      this.sortBy,
      this.filterByStock,
      this.minPrice,
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        ProductsFilterScreen(widget.categoryId)),
                              );
